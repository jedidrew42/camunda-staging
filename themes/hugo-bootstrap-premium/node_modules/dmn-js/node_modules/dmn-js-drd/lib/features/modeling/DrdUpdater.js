import { assign, map, forEach, pick } from 'min-dash';
 ...
 */
export default function DrdUpdater(eventBus, drdFactory, connectionDocking, drdRules, definitionPropertiesView) {
